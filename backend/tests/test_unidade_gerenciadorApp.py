...
def test_app_create_ingrediente_delegates_correctly(mocker, mock_dependencies):
    ...
    CORRIGIDO: O CreateIngrediente agora salva o ingrediente na memória
    (Nível de Teste: Unidade)
    """
    # --- Preparação ---
    ...
    # 3. CORRIGIDO: O ingrediente foi adicionado à memória?
    assert 1 in app.ingredientes
    assert app.ingredientes[1] == mock_ingrediente_criado